                            ...
                            <Grid item xs={5}>
                                ...
                                >
                                    {restaurantImgUrl === '' || restaurantImgUrl === undefined
                                        ...
                                        : (
                                            <img style={{  width: 'auto', height: 'auto', maxWidth: '100%', maxHeight: '100%' }} src={restaurantImgUrl} alt="thumbnail" />
                                        )}
                            ...
                            <Box sx={{ width: '100%' }}>
                                <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                                    <Tabs value={0} aria-label="basic tabs example">
                                        ...
                                        <div style={{ display: 'flex', justifyContent: 'center', flexDirection: 'column', cursor: 'pointer', marginLeft: '20px' }}>
                                            <Tooltip title="add menu"><PlusIcon onClick={() => { setUpdateMenuVis(true); setIsAdd(true); setMenuImgUrl('') }} /></Tooltip>
                                        </div>
                                    </Tabs>
                                </Box>
                        ...
                        <Grid item sx={{ paddingLeft: '10px', height: '253px' }}>
                            ...
                            >
                                {menuImgUrl === '' || menuImgUrl === undefined
                                    ...
                                    : (
                                        <img style={{  width: 'auto', height: 'auto', maxWidth: '100%', maxHeight: '100%' }} src={menuImgUrl} alt="thumbnail" />
                                    )}
